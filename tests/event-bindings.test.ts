...
function createDom(): MainDom {
  ...
  return {
    ...
    holdBeforeTypeCheckbox: createEmitterElement({ checked: false }) as any,
    holdBeforeTypeTimeoutInput: createEmitterElement({ value: "0" }) as any,
    holdBeforeTypeTimeoutField: { hidden: true } as any,
    privacyModeCheckbox: createEmitterElement({ checked: false }) as any,
    versionBanner: {} as any,
    versionBannerText: {} as any,
    versionBannerLink: {} as any,
